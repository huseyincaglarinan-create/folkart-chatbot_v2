...
def ask():
    try:
        ...
        # ✅ Local / Web için channel="local"
        answer = get_rag_answer(question, user_id=user_id, channel="local")
...
def whatsapp():
    try:
        ...
        # ✅ WhatsApp için channel="whatsapp"
        answer = get_rag_answer(incoming_msg, user_id=user_id, channel="whatsapp")
